...
One slot reserves both its dispatch activation and BF16 combine-output regions.
...
Attention and FFN ranks participate in the same CAM world with different buffer
settings.
